...
export const router = createBrowserRouter(
    createRoutesFromElements(
        <Route path={RouteE.HOME} element={<RootLayout />}>
            ...
            <Route path={RouteE.QUIZ_1} element={<Suspense><QuizLang /></Suspense>} />
            <Route path={RouteE.QUIZ_2} element={<Suspense><QuizGender /></Suspense>} />
            <Route path={RouteE.QUIZ_3} element={<Suspense><QuizAge /></Suspense>} />
            <Route path={RouteE.QUIZ_4} element={<Suspense><QuizBookHate /></Suspense>} />
            <Route path={RouteE.QUIZ_5} element={<Suspense><QuizFavTopics /></Suspense>} />
        </Route>
    )
)